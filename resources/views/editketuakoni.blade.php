    ...
    @section('judulmain','editketuakoninmain')
        ...
        <form action="/ketuakoni/edit/{{$row->id}}=update" method="POST">
            ...
            <body>
                <Datatable>
                    ...
                    <title>Edit data Ketua Koni</title>
                    <!- Bootstrap ->
                        ...
                        <!- Font Awesome ->
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="Nomer_Telepon" name="Nomer_Telepon" value="{{$row->Nomer_Telepon}}" id="Nomer_Telepon" class="form-control">
                                </div>
