        ...
        <div class="content-wrapper d-flex align-items-center auth theme-one">
          ...
          <div class="row w-100">
            <div class="col-md-12" style="margin-bottom: 20px;">
              <h2 style="text-align: center;">Halaman Log In</h2>
            </div>
            <div class="col-lg-4 mx-auto">
              ...
              <p class="footer-text text-center" style="margin-top: 20px;color: #308ee0">Copyright © {{date('Y')}} https://enfys.binggo.co.id - All rights reserved.</p>
            </div>
          </div>
        </div>
        <script>
