        ...
        <form action="/lihat-jadwal/create" method="POST" enctype="multipart/form-data">
            ...
            <body>
                <Datatable>
                    ...
                    <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha3844-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
