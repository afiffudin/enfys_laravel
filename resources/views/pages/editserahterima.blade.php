    ...
    @section('judulmain','editserahterimamain')
        ...
        <form action="/serah-terima/edit/{{$row->id}}=update" method="POST" enctype="multipart/form-data">
            ...
            <body>
                <Datatable>
                    ...
                    <title>Edit data Serah Terima</title>
                    <!- Bootstrap ->
                        ...
                        <!- Font Awesome ->
                            ...
                            <div class="form-group">
                                <form action="{{url('/serah-terima/edit/{id}=update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Tanggal_kepulangan" textarea class="form-control" value="{{$row->Tanggal_kepulangan}}"></input>
                                    </div>
                                    <div class="form-group">
